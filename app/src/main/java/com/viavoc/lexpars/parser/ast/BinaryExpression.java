...
public final class BinaryExpression implements Expression {
    ...
    private Value add(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return add((NumberValue) value1, value2);
            case ARRAY: return ArrayValue.add((ArrayValue) value1, value2);
            case MAP:
                if (value2.type() != Type.MAP)
    ...
    private Value subtract(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return subtract((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
    ...
    private Value multiply(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return multiply((NumberValue) value1, value2);
            case STRING: return multiply((StringValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value divide(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return divide((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value remainder(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return remainder((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value and(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return and((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value or(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return or((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value xor(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return xor((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value lshift(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return lshift((NumberValue) value1, value2);
            case ARRAY: return lshift((ArrayValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value rshift(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return rshift((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
    ...
    private Value urshift(Value value1, Value value2) {
        switch (value1.type()) {
            case NUMBER: return urshift((NumberValue) value1, value2);
            default:
                throw new OperationIsNotSupportedException(operation,
                        "for " + Types.typeToString(value1.type()));
        }
