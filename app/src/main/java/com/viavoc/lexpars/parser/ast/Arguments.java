...
import com.viavoc.lexpars.lib.StringValue;
...
public final class Arguments implements Iterable<Argument> {
    ...
    public void addRequired(Value name) {
        arguments.add(new Argument(name));
        requiredArgumentsCount++;
    }

    public void addRequired(String name) {
        arguments.add(new Argument(new StringValue(name)));
        requiredArgumentsCount++;
    }

    public void addOptional(Value name, Expression expr) {
