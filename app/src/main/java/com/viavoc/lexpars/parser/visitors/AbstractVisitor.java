...
public abstract class AbstractVisitor implements Visitor {
    ...
    @Override
    public void visit(TypedAssignmentExpression s) { s.expression.accept(this);}
    ...
    public void visit(TryCatchStatement s){
        visit((BlockStatement) s.tryBody);
        for (Pair<Expression, Statement> catcher : s.catchs) {
            visit((BlockStatement) catcher.type);
        }
    }
    ...
    @Override
    public void visit(NewExpression s) { }
